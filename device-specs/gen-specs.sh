...
for c in pru0 pru1; do
  gen_spec V3 am437x arm32 icss0 $c 4K 4K 32 256
done
for c in pru0 pru1; do
  gen_spec V3 am437x arm32 icss1 $c 12K 8K 32 512
done
...
for i in icss0 icss1; do
  for c in pru0 pru1; do
    gen_spec V3 am572x arm32 $i $c 12K 8K 32 512
  done
done
